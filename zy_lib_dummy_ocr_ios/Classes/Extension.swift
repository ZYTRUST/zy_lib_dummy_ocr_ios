...
extension UILabel {
    func fontRegular(fSize: CGFloat = 20){
        self.font = UIFont(name: "Lato-Regular", size: fSize)
    }
}

extension UIImageView {
    func setLottieAnimationView(psImageName: String) {
        ZyAnim.listAllLottieJSONFilesInPod(ivControl: self, psAnimationName: psImageName)
    }
}
